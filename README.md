...
Based in the Czech Republic · Senior System Engineer at Trask Solutions.
...
- **Edge cases and gotchas** — MG-scoped WIF bootstrap, Conditional Access C2/C3 binding, PIM activation timing.

---

## Where I write

**[trustanchor.pro](https://trustanchor.pro/?utm_source=gh-readme&utm_medium=profile&utm_campaign=community)** — production patterns from identity modernisation, banking application security, M365 tenant migrations, MSSP platforms, Azure Arc unified control plane, and global cybersecurity policy delivery. Hugo + GitHub Pages.
...
Whether you're modernising AD FS to Entra ID, hardening privileged access, designing landing zones at scale, or getting PATs and client secrets out of your delivery pipelines — [let's talk](https://www.linkedin.com/in/vaculikgeorge).

---

<sub>The principles are universal. The implementations are Microsoft.</sub>
